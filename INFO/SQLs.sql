...
-- Оновлення існуючої посади
UPDATE positions SET name = ? WHERE id = ?;

-- Видалення посади за її id
...
-- Оновлення даних працівників
UPDATE employees SET lastName = ?, firstName = ?, birthDate = ?,
positionId = ?, phone = ?, salary = ? WHERE id = ?;

-- Видалення працівника за його id
