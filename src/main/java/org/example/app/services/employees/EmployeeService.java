...
import org.example.app.controllers.employees.EmployeeDeleteController;
import org.example.app.controllers.employees.EmployeeReadController;
import org.example.app.controllers.employees.EmployeeUpdateController;
...
public class EmployeeService {
    ...
    public void updateEmployees() {
        EmployeeUpdateRepository repository = new EmployeeUpdateRepository();
        EmployeeUpdateService service = new EmployeeUpdateService(repository);
        EmployeeUpdateView view = new EmployeeUpdateView();
        EmployeeUpdateController controller = new EmployeeUpdateController(service, view);
        controller.updateEmployee();
    }

    public void deleteEmployee() {
        EmployeeDeleteRepository repository = new EmployeeDeleteRepository();
